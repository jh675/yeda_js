...
let html =
  "<hr><table border = 2><thead><tr><th>이름</th><th>연락처</th><th>생일</th><th>키</th></tr></thead><tbody>";
...
html += `<tr><td>평균키</td><td>${
  avgHei / friend.length
}</td><td>최대키</td><td>${maxHei}(${maxFnm})</td></tr></tbody></table>`;
